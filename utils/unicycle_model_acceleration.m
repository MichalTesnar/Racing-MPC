...
function [positions_x, positions_y, positions_theta, velocities] = unicycle_model_acceleration(velocity, acceleration, omega, current_x, current_y, current_theta, k, tau)
