...
controller = optimizer(constraints, objective,sdpsettings('solver','sedumi'),parameters_in,solutions_out);
x = [0;0];
clf;
...
for i = 1:300
    ...
    x = A*x + Bmodel*U(1)+E*disturbance;  % here, this makes me dizzy, since A does not take argument from x
    xhist = [xhist x];
    pause(0.05)   
